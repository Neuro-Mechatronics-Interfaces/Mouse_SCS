...
#define nrn_init _nrn_init__motoneuron_m2
#define _nrn_initial _nrn_initial__motoneuron_m2
#define nrn_cur _nrn_cur__motoneuron_m2
#define _nrn_current _nrn_current__motoneuron_m2
#define nrn_jacob _nrn_jacob__motoneuron_m2
#define nrn_state _nrn_state__motoneuron_m2
#define _net_receive _net_receive__motoneuron_m2 
#define evaluate_fct evaluate_fct__motoneuron_m2 
#define states states__motoneuron_m2 
...
#define m2_modulation _p[9]
#define m2_modulation_columnindex 9
#define tau_m_gain _p[10]
#define tau_m_gain_columnindex 10
#define tau_h_gain _p[11]
#define tau_h_gain_columnindex 11
#define tau_n_gain _p[12]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_motoneuron_m2", _hoc_setdata,
 "Exp_motoneuron_m2", _hoc_Exp,
 "alpham_motoneuron_m2", _hoc_alpham,
 "betam_motoneuron_m2", _hoc_betam,
 "evaluate_fct_motoneuron_m2", _hoc_evaluate_fct,
 0, 0
};
#define Exp Exp_motoneuron_m2
#define alpham alpham_motoneuron_m2
#define betam betam_motoneuron_m2
...
#define F F_motoneuron_m2
 double F = 96485.3;
#define R R_motoneuron_m2
 double R = 8.31447;
...
#define bmA bmA_motoneuron_m2
 double bmA = 0.4;
#define cai_min cai_min_motoneuron_m2
 double cai_min = 1e-06;
#define ca0 ca0_motoneuron_m2
 ...
 "tau_m_gain_motoneuron_m2", 0, 2,
 "tau_ca_motoneuron_m2", 10, 200,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ca0_motoneuron_m2", "mM",
 "cai_min_motoneuron_m2", "mM",
 "gnabar_motoneuron_m2", "mho/cm2",
 "gl_motoneuron_m2", "mho/cm2",
 "gkrect_motoneuron_m2", "mho/cm2",
 "gcaN_motoneuron_m2", "mho/cm2",
 "gcaL_motoneuron_m2", "mho/cm2",
 "gcak_motoneuron_m2", "mho/cm2",
 "ena_motoneuron_m2", "mV",
 "ek_motoneuron_m2", "mV",
 "el_motoneuron_m2", "mV",
 "m2_modulation_motoneuron_m2", "1",
 "tau_m_gain_motoneuron_m2", "1",
 ...
 "ca0_motoneuron_m2", &ca0_motoneuron_m2,
 "amA_motoneuron_m2", &amA_motoneuron_m2,
 "amB_motoneuron_m2", &amB_motoneuron_m2,
 "amC_motoneuron_m2", &amC_motoneuron_m2,
 "bmA_motoneuron_m2", &bmA_motoneuron_m2,
 "bmB_motoneuron_m2", &bmB_motoneuron_m2,
 "bmC_motoneuron_m2", &bmC_motoneuron_m2,
 "cai_min_motoneuron_m2", &cai_min_motoneuron_m2,
 "R_motoneuron_m2", &R_motoneuron_m2,
 "F_motoneuron_m2", &F_motoneuron_m2,
 0,0
};
...
#define _cvode_ieq _ppvar[0]._i
 ...
 "7.7.0",
"motoneuron_m2",
 "gnabar_motoneuron_m2",
 "gl_motoneuron_m2",
 "gkrect_motoneuron_m2",
 "gcaN_motoneuron_m2",
 "gcaL_motoneuron_m2",
 "gcak_motoneuron_m2",
 "ena_motoneuron_m2",
 "ek_motoneuron_m2",
 "el_motoneuron_m2",
 "m2_modulation_motoneuron_m2",
 "tau_m_gain_motoneuron_m2",
 ...
 "ina_motoneuron_m2",
 "il_motoneuron_m2",
 "ikrect_motoneuron_m2",
 "icaN_motoneuron_m2",
 "icaL_motoneuron_m2",
 "ikca_motoneuron_m2",
 "m_inf_motoneuron_m2",
 "mc_inf_motoneuron_m2",
 "h_inf_motoneuron_m2",
 "hc_inf_motoneuron_m2",
 "n_inf_motoneuron_m2",
 "p_inf_motoneuron_m2",
 "tau_m_motoneuron_m2",
 "tau_h_motoneuron_m2",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 motoneuron_m2 motoneuron_m2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Motor Axon Soma with M2 Receptor Modulation";
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   ...
   Dcai = 0.01 * ( - ( icaN + icaL ) - cai / ( 0.01 * tau_ca ) ) ;
   }
 return _reset;
}
 ...
 Dcai = Dcai  / (1. - dt*( ( 0.01 )*( ( ( - ( 1.0 ) / ( 0.01 * tau_ca ) ) ) ) )) ;
  return 0;
}
 /*END CVODE*/
 static int states (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) { {
   evaluate_fct ( _threadargscomma_ v ) ;
    ...
    cai = cai + (1. - exp(dt*(( 0.01 )*( ( ( - ( 1.0 ) / ( 0.01 * tau_ca ) ) ) ))))*(- ( ( 0.01 )*( ( - ( icaN + icaL ) ) ) ) / ( ( 0.01 )*( ( ( - ( 1.0 ) / ( 0.01 * tau_ca ) ) ) ) ) - cai) ;
   }
  return 0;
}
...
static int  evaluate_fct ( _threadargsprotocomma_ double _lv ) {
 ...
 _la = alpham ( _threadargscomma_ _lv ) ;
   ...
   tau_m = ( 1.0 / ( _la + _lb ) ) * tau_m_gain ;
   m_inf = _la / ( _la + _lb ) ;
   tau_h = ( 30.0 / ( Exp ( _threadargscomma_ ( _lv + 60.0 ) / 15.0 ) + Exp ( _threadargscomma_ - ( _lv + 60.0 ) / 16.0 ) ) ) * tau_h_gain ;
   h_inf = 1.0 / ( 1.0 + Exp ( _threadargscomma_ ( _lv + 65.0 ) / 7.0 ) ) ;
   tau_n = ( 5.0 / ( Exp ( _threadargscomma_ ( _lv + 50.0 ) / 40.0 ) + Exp ( _threadargscomma_ - ( _lv + 50.0 ) / 50.0 ) ) ) * tau_n_gain ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "motoneuron_m2.mod";
static const char* nmodl_file_text = 
  ":SOMA\n"
  "\n"
  ": Max Murphy\n"
