...
pptx = exportToPPTX('', ...
    ...
    'Comments','Uses modulation of gkrect in decades from 0.01x to 100x.');
pptx.addSlide();
...
for iFig = 1:numel(fig)
    ...
    utils.save_figure(fig(iFig),'export/NEURON/M2-Modulation',sprintf("Recruitment_Vsoma_%05.2gm2_Constant",fig(iFig).UserData.M2_Level));
end
...
for iFig = 1:numel(fig)
    ...
    pptx.addTextbox(num2str(slideId), ...
            ...
            'FontSize', 10);
    pptx.addPicture(fig(iFig),'Position',[0.5 0 9 6.5]);
    utils.save_figure(fig(iFig),'export/NEURON/M2-Modulation',sprintf("Recruitment_Vsoma_%05.2gm2_Increasing",fig(iFig).UserData.M2_Level));
end
...
for iFig = 1:numel(fig)
    ...
    pptx.addTextbox(num2str(slideId), ...
            ...
            'FontSize', 10);
    pptx.addPicture(fig(iFig),'Position',[0.5 0 9 6.5]);
    utils.save_figure(fig(iFig),'export/NEURON/M2-Modulation',sprintf("Recruitment_Vsoma_%05.2gm2_UpDown",fig(iFig).UserData.M2_Level));
end
...
for iFig = 1:numel(fig)
    ...
    pptx.addTextbox(num2str(slideId), ...
            ...
            'FontSize', 10);
    pptx.addPicture(fig(iFig),'Position',[0.5 0 9 6.5]);
    utils.save_figure(fig(iFig),'export/NEURON/M2-Modulation',sprintf("Recruitment_Vsoma_%05.2gm2_Decreasing",fig(iFig).UserData.M2_Level));
end
